package it.codeland.day12.core.servlets;
...
@SlingServletPaths(value = { "/bin/titles" })
public class Day18ServletExercisePathServlet extends SlingAllMethodsServlet {
    ...
    protected void doGet(final SlingHttpServletRequest req, final SlingHttpServletResponse resp)
        ...
        Page page = resourceResolver.adaptTo(PageManager.class).getPage("/content/day12/us/abdul-2000");
